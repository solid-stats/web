...
- [x] 01-05-PLAN.md — Workspace green gate + `.design/` freeze (WS-05)
...
- [x] 02-01-PLAN.md — Wave 0 harness: dev-deps + Vitest/Playwright-against-Ladle + the single `_fixtures` module + the `_state-matrix` helper (QUAL-03, QUAL-04, QUAL-05, QUAL-06)

**Wave 2** *(blocked on Wave 1)*

- [x] 02-02-PLAN.md — KIT-04 data-trust family (FreshnessPill, ProvenanceLine, TrustBadge, DataTrustBanner, InlineReviewRow) — proves the harness end-to-end (KIT-04)

**Wave 3** *(blocked on Wave 2 — shared barrel)*

- [x] 02-03-PLAN.md — KIT-07 feedback family (Skeleton, EmptyState, ErrorState, Toast, Badge, Pill) (KIT-07)

**Wave 4** *(blocked on Wave 3 — shared barrel)*

- [x] 02-04-PLAN.md — KIT-01 nav-shell family (AppShell, NavBar, MobileTabBar, SkipLink) (KIT-01)

**Wave 5** *(blocked on Wave 4 — shared barrel)*

- [x] 02-05-PLAN.md — KIT-03 stat primitives + Sparkline (StatTile, MiniStatGrid, TierChip, TierScale, Pips, Sparkline) (KIT-03)
...
- [x] 02-07-PLAN.md — GAP-19: Button/Link base primitive + refactor the ~7 hand-rolled controls onto it (KIT-01, KIT-02, KIT-07)

**Wave 2 (gap — blocked on 02-07)**

- [x] 02-08-PLAN.md — GAP-01..05: KIT-01 nav-shell rework (three-zone NavBar, universal account, raised breakpoint, 5-tab mobile, reveal-safe SkipLink) (KIT-01, QUAL-02, QUAL-03)
...
- [x] 03-02-PLAN.md — KIT-05 form family A: Field (label/error/live-region) + Input (KIT-05, QUAL-01/02/03/05)

**Wave 3** *(blocked on Wave 2 — barrel)*

- [x] 03-03-PLAN.md — KIT-05 form family B: Select (typed value) + Stepper (mono NumberInput) (KIT-05, QUAL-01/02/03/05)

**Wave 4** *(blocked on Wave 3 — barrel)*

- [x] 03-04-PLAN.md — KIT-05 form family C: FileUpload (keyboard dropzone, SVG-excluded accept, object-URL revoke) (KIT-05, QUAL-01/02/03/05)

**Wave 5** *(blocked on Wave 4 — barrel)*

- [x] 03-05-PLAN.md — KIT-06 overlay family A: Dialog (focus trap, destructive-confirm) + Popover (KIT-06, QUAL-01/02/03/04/05)

**Wave 6** *(blocked on Wave 5 — barrel)*

- [x] 03-06-PLAN.md — KIT-06 overlay family B: Menu + Tabs (roving tabindex) + Tooltip (KIT-06, QUAL-01/02/03/05)
...
- [x] 03-14-PLAN.md — GAP-12/13/15/16/17: 360 story wrappers, FileUpload bounded list, Select 360 max-width cap, a11y/dead-code sweep, reserve-only FU7 keys + itemStatus slot (QUAL-02, KIT-05, QUAL-03, KIT-06, SURF-18)
- [x] 03-15-PLAN.md — GAP-14: caption-color DESIGN.md token decision + gen-theme re-export (isolated design-system workflow) (KIT-05, QUAL-03)
...
- [x] 04-02-PLAN.md — Stats Overview surface story, scenario/data-volume states, responsive and CLS checks (SURF-01, QUAL-01, QUAL-02, QUAL-03, QUAL-04, QUAL-05, QUAL-06)
- [x] 04-03-PLAN.md — Players list surface story, loading model, desktop visual table contract, mobile top-N/show-more (SURF-02, QUAL-01, QUAL-02, QUAL-03, QUAL-04, QUAL-05, QUAL-06)
- [x] 04-04-PLAN.md — Player Profile surface story, identity/hero stats/tabs/provenance, responsive and CLS checks (SURF-03, QUAL-01, QUAL-02, QUAL-03, QUAL-04, QUAL-05, QUAL-06)
