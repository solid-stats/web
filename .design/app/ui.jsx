...
/* ---- Provenance line ---- */
function Provenance({ children = 'Up to date · updated 4 min ago', live = true }) {
  return <span className="prov">{live && <span className="dot" />}{children}</span>;
}

Object.assign(window, { useState, useMemo, useEffect, useRef, Icon, BrandMark, Brand, Button, Badge, Tile, Tabs, Avatar, Sparkline, Provenance, OUTCOME });
