...
> lookup) live in `solid-stats/agent-instructions`, loaded by the managed bridge above.
> Stack-specific skills live in `solid-stats/skills`
> (`solidstats-shared-project-standards` and this repo's own skills).
